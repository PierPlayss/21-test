...
void RenderWindow::customRect(int vx1,int vy1, int vx2, int vy2, int vx3, int vy3, int vx4, int vy4, SDL_Texture* texture) {

	/*SDL_Vertex vertex_1 = {{100, 100}, {255, 255, 255, 255}, {1, 1}};
	SDL_Vertex vertex_2 = { {200, 100}, {255, 255, 255, 255}, {1, 1} };
	SDL_Vertex vertex_3 = { {100, 200}, {255, 255, 255, 255}, {1, 1} };
